...
(function($) {
  ...
  $.purr = function(notice, options)
  {
    ...
    // Set attribute to which the container should be added
    var attr = $.data(notice[0], 'attribute' );                            
    ...
    // Add the container after the attribute
    cont.insertAfter($('[data-attribute="' + attr +'"]'));
